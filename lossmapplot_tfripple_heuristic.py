...
fn='/home/vallar/WORK/ASCOT/SA_003/ripple/pnb/perp/ascot_ripple_poincare.h5'
...
gs  = GridSpec(1,3, top=0.73, bottom=0.18)
...
axb.set_xlabel(r"$\rho$ at outer mid-plane $(\rho')$")
