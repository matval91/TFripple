...
def evaluate_derived_quant(orb, id_part):
    ...
    pitch=eval_mrkr.eval_particle('pitch', mass=2.*1.60e-27, charge=None,
...
def evaluate_initial_quant(inistate, id_part):
    ...
    mu=eval_mrkr.eval_particle('mu', mass=2.*1.60e-27, charge=None,
                  R=None, phi=None, z=None,
                  vR=inistate['vr'][ind_i_coll], vphi=inistate['vphi'][ind_i_coll], vz=inistate['vz'][ind_i_coll],
                  BR=inistate['br'][ind_i_coll], Bphi=inistate['bphi'][ind_i_coll], Bz=inistate['bz'][ind_i_coll], psi=None)
    print('initial mu', mu)
    return ind, mu
